...
class Logs(commands.Cog):
    ...
    async def on_message_delete(self, message):
        if message.guild.id == get_from_environment('MAIN_GUILD', int) and message.channel.id != (718973124078731354) and message.channel.id != (1151940373720080435):
    ...
    async def on_message_edit(self, before, after):
        if after.guild.id == get_from_environment('MAIN_GUILD', int) and before.content != after.content and after.channel.id != (718973124078731354) and after.channel.id != (1151940373720080435):
            await self.backup_log(
